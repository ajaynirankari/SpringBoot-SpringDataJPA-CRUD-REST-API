package com.gl.EmployeeManagementApplication;
...
class LoadDefaultData {
    ...
    CommandLineRunner initializeDatabase(EmployeeJpaRepository jpaRepository) {
        return args -> {
            Employee employee1 = new Employee("Smith", "Dev");
            Employee employee2 = new Employee("Marry", "IT");
            Employee employee3 = new Employee("Paul", "Tested");
            Employee employee4 = new Employee("Zim", "Doc");
            Employee employee5 = new Employee("Kenith", "Dev");
